...
class Default_Model_Employeeleaves extends Zend_Db_Table_Abstract
{
	...
	public function SaveorUpdateEmployeeLeaves($user_id,$emp_leave_limit,$isleavetrasnfer,$loginUserId)
	{
		...
		$query = "INSERT INTO `main_employeeleaves` (user_id,emp_leave_limit,used_leaves,alloted_year,createdby,modifiedby,createddate,modifieddate,isactive,isleavetrasnferset) VALUES (".$user_id.",".$emp_leave_limit.",'0',year(now()),".$loginUserId.",".$loginUserId.",'".$date."','".$date."',1,".$isleavetrasnfer.") ON DUPLICATE KEY UPDATE emp_leave_limit='".$emp_leave_limit."',modifiedby=".$loginUserId.",modifieddate='".$date."',isactive = 1,isleavetrasnferset=".$isleavetrasnfer." ";
