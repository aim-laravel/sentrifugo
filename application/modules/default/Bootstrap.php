...
class Default_Bootstrap extends Zend_Application_Bootstrap_Bootstrap
{
    ...
    public function _initRoutes()
    {
         ...
         */
		$routeLK = new Zend_Controller_Router_Route('lk', array(
            'module' => 'default',
            'controller' => 'index',
            'action' => 'welcome'
        ));

        $routeTest = new Zend_Controller_Router_Route('test', [
            'module' => "default",
            'controller' => 'index',
            'action' => 'welcome'
        ]);

        $routeTest2 = new Zend_Controller_Router_Route('lakshay', [
            'module' => "default",
            'controller' => 'index',
            'action' => 'lakshay'
        ]);

        $router->addRoute('lk', $routeLK);
        $router->addRoute('testURL', $routeTest);
        $router->addRoute('lakshay', $routeTest2);
    }
}
